...
{
    /**
     * @param  array{status: array{device_id: int, device_channel_id: int, parameter_key: string}|null, length: array{device_id: int, device_channel_id: int, parameter_key: string}|null}  $sources
    ...
    /**
     * @return array{status: array{device_id: int, device_channel_id: int, parameter_key: string}|null, length: array{device_id: int, device_channel_id: int, parameter_key: string}|null}
     */
